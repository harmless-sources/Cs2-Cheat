  ...
  public class Helpers
    {
      ...
      public static extern void mouse_event(uint dwFlags, uint dx, uint dy, uint dwData, int dwExtraInfo);
        ...
        public Helpers(string procName)
        {
        ...
        public byte ReadByte(IntPtr address, int offset)
        {
            ...
            IntPtr fullAddress = (IntPtr)((long)address + offset);
            ReadProcessMemory(proc.Handle, fullAddress, buffer, buffer.Length, IntPtr.Zero);
            return buffer[0];
        }
        ...
        public void WriteMemory<T>(IntPtr addr, T val)
        {
            ...
            WriteProcessMemory(proc.Handle, addr, buffer, size, IntPtr.Zero);
        }
